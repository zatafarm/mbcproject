										...
										<div class="row">
											<div class="col-lg-12">
												<div class="detail_form">
													<form action="/Updateempoly" method="post" enctype="multipart/form-data">
														<fieldset>
															<div class="field">
																...
																<div class="photo-container" style= "margin-left: 130px;">
																	...
																	<input type="hidden" id ="checkpic" name ="checkpic" value = "0" />
																</div>
															</div>
															<br><br>
															<div class="field">
																<label class="label_field">입사일자</label> <input type="text"
																	name="hrdt" value="<c:out value="${emp.hrdt}" />"
																	readonly />
															</div>
															<div class="field">
															...
															<div class="field">
																<label class="label_field">이름</label> <input type="text"
																	name="ename" id="ename" value="<c:out value='${emp.ename}'/>" />
															</div>
															<div class="field">
															...
															<div class="field">
																<label class="label_field">휴대전화번호</label> <input type="text"
																	name="tel" id="tel" value="<c:out value='${emp.tel}'/>" maxlength="13" />
															</div>
															<div class="field">
																<label class="label_field">내선번호</label> <input type="text"
																	name="ctel" id="ctel" value="<c:out value='${emp.ctel}'/>" maxlength="4" />
															</div>
															<div class="field">
																<label class="label_field">이메일</label> <input type="email"
																	name="email" id="email" value="<c:out value='${emp.email}'/>" />
															</div>
															<div class="field">
															...
															<div class="field">
																<label class="label_field"></label> <input type="text"
																	name="dtlAdr" id="dtlAdr" value="<c:out value='${emp.adr2}'/>" />
															</div>
															<div class="field">
																<label class="label_field"></label> <input type="text"
															...
															<div class="field">
																...
																<label class="label_field">기본급</label> <input type="text"
																	name="sal" id="sal" value="<c:out value='${emp.sal}'/>" />
															</div>
															<div class="field">
															...
															<div class="field margin_0">
																...
																<button class="btn btn-secondary" type="button" onclick = "location.href = '/adminempolydetail?empno=${emp.empno}' ">취소</button>
															</div>
														</fieldset>
													</form>
												</div>
