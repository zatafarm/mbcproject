...
<jsp:include page='/WEB-INF/views/include/body.jsp' />
   ...
   <!-- Main -->
   <form role="form" onsubmit="return validate();" method="post" action="/ptoModify">
                                 ...
                                 <table class="table table-striped projects">
                                    ...
                                    <tr>
                                       ...
                                       <td><select id="ptotp" name="ptotp">
                                          <option>--선택--</option>
                                          <option value="T0" ${aprv.ptotp == 'T0' ? 'selected' : ''}>연차</option>
                                          <option value="T1" ${aprv.ptotp == 'T1' ? 'selected' : ''}>반차</option>
                                          <option value="T2" ${aprv.ptotp == 'T2' ? 'selected' : ''}>기타</option>
                                          </select>
                                       </td>
                                       <th>사용 개수</th>
                                       <td><input type="number" name="usp" max="${aprv.rstpto}" value="${aprv.usp}">개</td>
                                    </tr>
                                    <tr>
                                       <th>휴가 시작일</th>
                                       <td><input type="text" class="date" id="strdt" name="strdt" value="${aprv.strdt}"></td>
                                       <th>휴가 종료일</th>
                                       <td><input type="text" class="date" id="endt" name="endt" value="${aprv.endt}"></td>
                                    </tr>
                                    <tr>
                                       <th>신청 사유</th>
                                       <td colspan="3"><textarea name="ptorea" rows="5" cols="100">${aprv.ptorea}</textarea></td>
                                    </tr>
                                    <tr>
