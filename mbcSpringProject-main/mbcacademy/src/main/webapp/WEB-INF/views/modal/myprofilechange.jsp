            ...
            <div class="employee-card2">
                <div class="main-info">
				    ...
				    <tr>
				        ...
				        <td class="content-column">${emp.fmtSal}</td>
				    </tr>
                ...
                <div class="additional-info">
                    <div class="row" style="margin-left: auto">
                        ...
                        <input class="info-input" type="text" value="031" maxlength="3" />
					    <span class="hyphen">-</span>
					    <input class="info-input" type="text" value="2222" maxlength="4" />
					    <span class="hyphen">-</span>
					    <input class="info-input" type="text" value="<c:out value='${emp.ctel}' />" maxlength="4" id = "ctel"/>		    
					    </div>
                    </div>  
                    <div class="row" style="margin-left: auto">
                        <p class= "info-title">휴대폰 번호:</p>
                             <div style="margin-left: 10px">
                        <input class="info-input" type="text" maxlength="3"id = "p1" name = "p1" />
					    <span class="hyphen">-</span>
					    <input class="info-input" type="text" maxlength="4" id = "p2" name = "p2" />
					    <span class="hyphen">-</span>
					    <input class="info-input" type="text" maxlength="4" id = "p3" name = "p3" />
					    </div>
                    </div>
                    <div class="row" style="margin-left: auto">
                        <p class= "info-title">이메일:</p>
                        <input type="email" value="<c:out value='${emp.email}' />" style="width: 300px; height: 25px; margin-left: 10px; font-size: 12px" id = "email" name = "email"  >
                    </div>
                    <div class="row" style="margin-left: auto">
                       <p class= "info-title">주소:</p>
                       <input type="email" value="<c:out value='${emp.adr}' />" style="width: 500px; height: 25px; margin-left: 10px; font-size: 12px" id = "adress" name = "adress"   >
                    </div>
